...
return [
    ...
    'columns' => [
        ...
        'l18n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_persistence_entity_symmetric.pid=###CURRENT_PID### AND tx_persistence_entity_symmetric.sys_language_uid IN (-1,0)',
                'default' => 0
            ]
        ],
        'l18n_diffsource' => [
    ...
    'types' => [
        '0' => ['showitem' =>
            '--div--;LLL:EXT:irre_tutorial/Resources/Private/Language/locallang_db.xml:tabs.general, title, entity, peer,' .
