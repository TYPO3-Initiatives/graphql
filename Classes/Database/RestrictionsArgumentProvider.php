...
use TYPO3\CMS\GraphQL\Type\RestrictionContainerType;

/**
 * @internal
 */
class RestrictionsArgumentProvider
{
    /**
     * @var string
     */
    const ARGUMENT_NAME = 'restrictions';

    /**
     * @var InputObjectType
     */
    private static $restrictionContainerType;
    ...
    public function __invoke(BeforeFieldArgumentsInitializationEvent $event): void
    {
        ...
        $event->addArgument(self::ARGUMENT_NAME, RestrictionContainerType::instance());
    }
}